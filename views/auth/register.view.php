...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-white">New Here? Register</h2>
  </div>
      ...
      <div>
        ...
        <div class="mt-2">
          ...
          <?php if (isset($errors['password'])): ?>
            <p class="text-red-800 text-xl bold mt-1"><?= $errors['password'] ?></p>
          <?php endif; ?>
        </div>
      </div>
