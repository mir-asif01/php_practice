      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <a href="/" aria-current="page" class="<?= $_SERVER['REQUEST_URI'] === '/' ? 'bg-gray-950/50' : '';  ?> ?> rounded-md  px-3 py-2 text-sm font-medium text-white">Home</a>
            <a href="/notes" aria-current="page" class="<?= $_SERVER['REQUEST_URI'] === '/about.php' ? 'bg-gray-950/50' : '';  ?> ?> rounded-md px-3 py-2 text-sm font-medium text-white">Notes</a>
            <a href="/about" aria-current="page" class="<?= $_SERVER['REQUEST_URI'] === '/about.php' ? 'bg-gray-950/50' : '';  ?> ?> rounded-md px-3 py-2 text-sm font-medium text-white">About</a>
            <a href="/contact" aria-current="page" class="<?= urlIs('/contact.php') ? 'bg-gray-950/50' : '';  ?> ?> rounded-md px-3 py-2 text-sm font-medium text-white">Contact</a>
          </div>
        </div>
      </div>
      <!-- <div class="hidden md:block">
